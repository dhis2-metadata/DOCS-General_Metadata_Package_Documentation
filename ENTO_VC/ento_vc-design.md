...
DHIS2, in collaboration with the WHO, organized a [webinar](https://youtu.be/9NwZPWGkNsU) to explain and outline the use cases for the use of the "Breeding sites", "ITN - Bioefficacy" and "IRS - Residual efficacy" packages.
